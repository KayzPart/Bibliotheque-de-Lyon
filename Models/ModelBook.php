...
class ModelBook extends Model {
    public function listAll() {
        $db = $this->getDb();
        $req = $db->query('SELECT category.`name_category`, `title`, `author`, `year_published`, `descrip`, `isbn`, `photo`, `emplacement`, `lang`, `condition` FROM `book` INNER JOIN category ON book.id_category = category.id_category');
